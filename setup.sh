...
# This script installs all necessary C++ development dependencies
...
# 2. Install Build System and Basic Tools 
echo -e "\n--- Installing basic development tools (Compilers, CMake, Ninja, Ccache, GDB) ---"
sudo apt install build-essential gdb cmake ninja-build ccache -y
...
# The script assumes 'external/FTXUI' as the target path.
